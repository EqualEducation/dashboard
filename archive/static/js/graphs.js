...
//  console.log(projectsJson);
  ...
  //var max_state = totalDonationsByState.top(1)[0].value;
	...
	.size(1000)
    .columns([
      function(d) { return d["schoolDetails"]["INSTITUTION_NAME"]; },
      function(d) { return d["schoolDetails"]["CLASSIFICATION"]; },
      function(d) { return d["schoolDetails"]["PROVINCE_NAME"]; },
      function(d) { return d["schoolDetails"]["TOWN_OR_CITY"]; },
      function(d) { return d["schoolDetails"]["DISTRICT_NAME"]; },
      function(d) { return d["schoolDetails"]["TELEPHONE_NO"]; },
      function(d) { return d["schoolDetails"]["NEIMS_NUMBER"]; },
    ])
    .sortBy(function(d){ return d["schoolDetails.INSTITUTION_NAME"]; })
    .order(d3.ascending);
